...
class EditorFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        super(EditorFrame, self).__init__(
            None, -1, self.__APP_NAME, style=wx.CENTER | wx.DEFAULT_FRAME_STYLE)
        ...
        StatusBarManager().UpdateStatusBar(
            "Init Statusbar", "Smart selection not active")
        # Events -----
        ...
        self.Bind(
            wx.EVT_TOOL, self.ClearGridSparks, id=self.__IDs['ID_CLEARSPARKS'])
        self.Bind(
            wx.EVT_TOOL, self.ClearGridLinks, id=self.__IDs['ID_CLEARLINKS'])
        ...
        self.Bind(
            wx.EVT_TOOL, self.InsertAutomata1d, id=self.__IDs['ID_AUTOMATA1D'])
...
If not, see http://www.gnu.org/licenses/."""
    ...
    def _SetupToolBar(self):
        ...
        self._tb1.AddLabelTool(
            self.__IDs[
                "ID_CLEARSPARKS"], "Clear Sparks", self.__resman.button.clearsparks,
            shortHelp="Clear Sparks", longHelp="Delete all the sparks in the current grid opened"
        )
        self._tb1.AddLabelTool(
            self.__IDs[
                "ID_CLEARLINKS"], "Clear Links", self.__resman.button.clearlinks,
        ...
        self._tb1.AddCheckLabelTool(
            self.__IDs[
                "ID_SMART_SEL"], "Smart Selection", self.__resman.button.smartselection,
        ...
        self._tb2.AddLabelTool(
            self.__IDs[
                "ID_A_DOWN"], "Arrow DOWN", self.__resman.button.arrowdown,
            shortHelp="Arrow DOWN", longHelp="Inserts an arrow down entity"
        )
        self._tb2.AddLabelTool(
            self.__IDs[
                "ID_A_RIGHT"], "Arrow RIGHT", self.__resman.button.arrowright,
            shortHelp="Arrow RIGHT", longHelp="Inserts an arrow right entity"
        )
        self._tb2.AddLabelTool(
            self.__IDs[
                "ID_A_LEFT"], "Arrow LEFT", self.__resman.button.arrowleft,
            shortHelp="Arrow LEFT", longHelp="Inserts an arrow left entity"
        )
        self._tb2.AddLabelTool(
            self.__IDs[
                "ID_AUTOMATA1D"], "1D Automata", self.__resman.button.automata1d,
    ...
    def _SetupMenus(self):
        ...
        environment = wx.Menu()
        environment.Append(
            self.__IDs["ID_SMART_SEL"], "Smart selection", kind=wx.ITEM_CHECK)
        environment.Append(
            self.__IDs["ID_MINIMAP"], "Minimap", kind=wx.ITEM_CHECK)
        environment.Append(
            self.__IDs["ID_CHESS"], "Chess creation", kind=wx.ITEM_CHECK)
        ...
        items.Append(
            self.__IDs["ID_LINK"], "Links Manager", kind=wx.ITEM_CHECK)
